                      ...
                      <div class="col-lg-6 col-md-12 col-6 mb-4">
                        <div class="card">
                          <div class="card-body">
                            ...
                            <h3 class="card-title mb-2">160M</h3>
                      ...
                      <div class="col-lg-6 col-md-12 col-6 mb-4">
                        <div class="card">
                          <div class="card-body">
                            ...
                            <span>Profit</span>
                            <h3 class="card-title text-nowrap mb-1">90M</h3>
                      ...
                      <div class="col-6 mb-4">
                        <div class="card">
                          <div class="card-body">
                            ...
                            <span class="d-block mb-1">Session</span>
                            <h3 class="card-title text-nowrap mb-2">400 Hours</h3>
                            ...
                            <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                              <div class="d-flex flex-sm-column flex-row align-items-start justify-content-between">
                                <div class="card-title">
                                  <h5 class="text-nowrap mb-2">Revenue</h5>
                                  <span class="badge bg-label-warning rounded-pill">Year 2022</span>
                                </div>
                                <div class="mt-sm-auto">
                                  <small class="text-success text-nowrap fw-semibold"
                                    ><i class="bx bx-chevron-up"></i> 100%</small
                                  >
                                  <h3 class="mb-0">100M</h3>
                                </div>
                              </div>
